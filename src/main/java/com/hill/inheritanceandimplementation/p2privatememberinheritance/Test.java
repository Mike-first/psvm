...
//AClass has private int x. is this field in the BClass object? yes, it is. you can see it in the debugger
//how to access this field in BClass? public int getX() is inherited in BClass and can be called.
//what exactly will public int getX() return in BClass? the value of the field. if it was not defined, then by default.
