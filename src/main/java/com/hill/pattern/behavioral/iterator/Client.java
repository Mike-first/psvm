//Iterator
//allows you to sequentially iterate through the elements of a collection without revealing the internal structure

package com.hill.pattern.behavioral.iterator;
